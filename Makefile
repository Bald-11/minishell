...
SRC_FILES = main.c input.c utils.c utils2.c utils3.c utils4.c tokens.c tokenizer.c tokenizer2.c parser.c parser2.c redir.c cmds.c exec.c ft_split.c builtins.c
